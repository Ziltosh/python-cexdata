            ...
            for coin in coins:
                ...
                if dt_or_false:
                    ...
                    if all_df:
                        ...
                        final.set_index('timestamp', drop=False, inplace=True)
            ...
            for name in files:
                if os.path.join(path, name).endswith('.csv'):
                    ...
                    files_data.append({
                        ...
                        "start_date": str(datetime.fromtimestamp(df_file.iloc[0]["timestamp"]/1000)),
                        "end_date": str(datetime.fromtimestamp(df_file.iloc[-1]["timestamp"]/1000))
                    })
